...
ActiveRecord::Schema[7.0].define(version: 2022_12_01_205952) do
  ...
  create_table "quotation_details", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_quotation_details_on_user_id"
  end
  ...
  add_foreign_key "quotation_details", "users"
