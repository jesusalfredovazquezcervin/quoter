Myapp::Application.routes.draw do
  resources :quotation_details, except: [:new]

  get "quotation_details/new/:id", to: "quotation_details#new", as: "new_quotation_detail"
  ...
  #get "quotation_details/new/:id", to: "quotation_details#create", as: "create_quotation_detail"
