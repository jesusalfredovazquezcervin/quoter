...
class ConsultantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create consultant" do
    assert_difference("Consultant.count") do
      post consultants_url, params: { consultant: { code: @consultant.code, email: @consultant.email, fullName: @consultant.fullName, phoneNumber: @consultant.phoneNumber, role: @consultant.role } }
    end
  ...
  test "should update consultant" do
    patch consultant_url(@consultant), params: { consultant: { code: @consultant.code, email: @consultant.email, fullName: @consultant.fullName, phoneNumber: @consultant.phoneNumber, role: @consultant.role } }
